...
About two months ago, I started working on a project to run a ComfyUI workflow on a serverless platform ([runpod.io](https://runpod.io)). My goal was to use a combination of models, custom nodes, and workflows that originally worked on a basic ComfyUI server setup.
