    ...
    return (
        <>
            ...
            <p className=' text-foreground-muted dark:text-muted'>
                I build products with my team @ shamps.dev, currently pursuing a Software Engineering degree at ITMO University. I&apos;m a full-stack developper profficient in C#, Golang and Typescript.
            </p>
            <div className='mt-16'>
                ...
                <div className='flex flex-col gap-4 sm:gap-1'>
                    <div className='-mx-3 flex flex-col rounded-md px-3 no-underline hover:bg-[#F5F4F4] dark:hover:bg-[#191918] sm:py-3'>
                        <div className="flex justify-between">
                            <h1 className='cursor-pointer w-fit'>r2r.studio</h1>
                    ...
                    <div className='-mx-3 flex flex-col rounded-md px-3 no-underline hover:bg-[#F5F4F4] dark:hover:bg-[#191918] sm:py-3'>
                        <div className="flex justify-between">
                            <h1 className='cursor-pointer w-fit'>Sidus Heroes</h1>
