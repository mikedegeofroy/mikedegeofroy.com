    ...
    return (
        <html lang="en">
          ...
          `}
            ...
            >
                <header className="mb-32 sm:ml-3 flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        <a
                            target="_blank"
                            href={"https://github.com/mikedegeofroy"}
                            className="p-3 hover:bg-[#F5F4F4] dark:hover:bg-[#191918] rounded-xl"
                        >
                            <Icons.github />
                        </a>
                        <a
                            target="_blank"
                            href={"https://t.me/mikedegeofroy"}
                            className="p-3 hover:bg-[#F5F4F4] dark:hover:bg-[#191918] rounded-xl"
                        >
                            <Icons.telegram />
                        </a>
                ...
                <main className="flex-grow flex flex-col sm:px-3">
                    {children}
                    <div className="mt-16">
